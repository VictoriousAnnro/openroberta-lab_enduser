function init() {
  COMM.setErrorFn(handleServerErrors),
    $.when(languageController.init())
      .then(function (o) {
        return webviewController.init(o);
      })
      .then(function (o, r) {
        return guiStateController.init(o, r);
      })
      .then(function () {
      ...
      .then(function () {
        menuController.init(initProgramming),
          $("#sliderDiv").hide(),
          guiStateController.getStartWithoutPopup() ||
...
require.config({
  ...
  paths: {
    ...
    "bootstrap-table-locals":
      "libs/bootstrap/bootstrap-table-1.22.1-dist/js/bootstrap-table-locale-all.min",
    ...
    "configuration.controller":
      "js/app/roberta/controller/configuration.controller",
    ...
    "galleryList.controller":
      "js/app/roberta/controller/galleryList.controller",
    "tutorialList.controller":
      "js/app/roberta/controller/tutorialList.controller",
    ...
    "notification.controller":
      "js/app/roberta/controller/notification.controller",
    ...
    "progTutorial.controller":
      "js/app/roberta/controller/progTutorial.controller",
    ...
    "sourceCodeEditor.controller":
      "js/app/roberta/controller/sourceCodeEditor.controller",
    "connection.interface":
      "js/app/roberta/controller/connections/connection.interface",
    "abstract.connections":
      "js/app/roberta/controller/connections/abstract.connections",
    ...
    "robot.base.stationary":
      "js/app/simulation/simulationLogic/robot.base.stationary",
    "robot.base": "js/app/simulation/simulationLogic/robot.base",
    "simulation.objects":
      "js/app/simulation/simulationLogic/simulation.objects",
    ...
    "simulation.roberta":
      "js/app/simulation/simulationLogic/simulation.roberta",
    ...
    "interpreter.interpreter":
      "js/app/nepostackmachine/interpreter.interpreter",
    "interpreter.aRobotBehaviour":
      "js/app/nepostackmachine/interpreter.aRobotBehaviour",
    "interpreter.robotWeDoBehaviour":
      "js/app/nepostackmachine/interpreter.robotWeDoBehaviour",
    "interpreter.robotSimBehaviour":
      "js/app/nepostackmachine/interpreter.robotSimBehaviour",
  ...
  shim: {
    webots: { deps: ["glm", "webots.enum", "webots.wren"] },
    "@cor3ntin/flexbuffers-wasm": { exports: "FlexBuffers" },
    flatbuffers: {
      exports: "flatbuffers",
      init: function () {
        return this;
    ...
    "lodash.isequal": { exports: "isEqual" },
    thymio: {
    ...
    "bootstrap-table-locals": { deps: ["bootstrap-table"] },
    "bootstrap-tagsinput": { deps: ["bootstrap-table"] },
    "bootstrap.wysiwyg": { deps: ["bootstrap-table"] },
    blockly: { exports: "Blockly" },
    confVisualization: { deps: ["blockly"] },
    robotBlock: { deps: ["blockly"] },
    port: { deps: ["blockly"] },
    "volume-meter": {
      exports: "VolumeMeter",
      init: function () {
        return { createAudioMeter: createAudioMeter };
      },
    },
  ...
  require([
    ...
    (function waitForWorkspace(attemptsLeft){
      ...
      (guiStateController = o("guiState.controller")),
      (languageController = o("language.controller")),
      (logListController = o("logList.controller")),
      (menuController = o("menu.controller")),
      (progDeleteController = o("progDelete.controller")),
      (progListController = o("progList.controller")),
      (galleryListController = o("galleryList.controller")),
      (tutorialListController = o("tutorialList.controller")),
      (legalController = o("legal.controller")),
      (programController = o("program.controller")),
      (progHelpController = o("progHelp.controller")),
      (progInfoController = o("progInfo.controller")),
      (notificationController = o("notification.controller")),
      (progCodeController = o("progCode.controller")),
      (progSimController = o("progSim.controller")),
      (progRunController = o("progRun.controller")),
      (progShareController = o("progShare.controller")),
      (robotController = o("robot.controller")),
      (userController = o("user.controller")),
      (nnController = o("nn.controller")),
      (userModel = o("user.model")),
      (tutorialController = o("progTutorial.controller")),
      (userGroupController = o("userGroup.controller")),
      (webviewController = o("webview.controller")),
      (sourceCodeEditorController = o("sourceCodeEditor.controller")),
      (confVisualization = o("confVisualization")),
      (robotBlock = o("robotBlock")),
      (startViewController = o("startView.controller")),
      (connectionController = o("connection.controller")),
      (aceEditor = o("aceEditor")),
      $(document).ready(WRAP.wrapTotal(init, "page init"));
  });
var mainCallbackCalled = !1;
function initProgramming(o, r, t, e) {
  var l = t,
    n = e;
  mainCallbackCalled
    ? robotController.switchRobot(o, r, null, function () {
        $(".mainTab").parent().removeClass("invisible"),
          $("#header").addClass("shadow"),
          $(".notStart").removeClass("disabled"),
          $("#tabProgram").oneWrap("shown.bs.tab", function () {
            l && "function" == typeof l && l.apply(void 0, n);
          }),
          $("#tabProgram").tabWrapShow();
      })
    : ((mainCallbackCalled = !0),
      $.when(robotController.init(o, r)).then(function () {
        $(".mainTab").parent().removeClass("invisible"),
          $(".notStart").removeClass("disabled"),
          $("#header").addClass("shadow"),
          ...
          connectionController.initConnection(o),
          $("#tabProgram").oneWrap("shown.bs.tab", function () {
            l && "function" == typeof l && l.apply(void 0, n);
          }),
          $("#tabProgram").tabWrapShow();
...
function handleServerErrors(o) {
  LOG.error("Client connection issue: " + o.status),
    "/rest/ping" === this.url && (COMM.errorNum += 1),
    ("/rest/ping" === this.url && COMM.errorNum != ALLOWED_PING_NUM) ||
      (o.status && o.status < 500
