...
Blockly.Msg.ACTION_DISPLAY = "display";
...
Blockly.Msg.ACTION_PLAY_RECORDING_TOOLTIP_THYMIO = "Play sound Rx.wav from the SD card, where >>x<< is the name of the recording supplied. An SD card is required!";
...
Blockly.Msg.AIFES_ADD_CLASSIFY_DATA = "add classify data";
Blockly.Msg.AIFES_ADD_CLASSIFY_DATA_TOOLTIP = "add classify data (multiple times). Then extract the input features from it and add that to the classifiy data";
Blockly.Msg.AIFES_ADD_RAW_DATA = "add to training dataset";
Blockly.Msg.AIFES_ADD_RAW_DATA_TOOLTIP = "add training data (multiple times). Then extract the input features from it and add that to the trainings data";
Blockly.Msg.AIFES_ADD_TARGET_DATA = "add to target data";
Blockly.Msg.AIFES_ADD_TARGET_DATA_TOOLTIP = "take raw data, execute feature extraction and add the data from feature extraction to the collection of training data for a class";
Blockly.Msg.AIFES_CLASSIFY = "classify";
...
Blockly.Msg.AIFES_CLASS_NUMBER = "class number";
Blockly.Msg.AIFES_CLASS_PROBABILITIES = "probabilities";
Blockly.Msg.AIFES_CONFIGURATION_ERROR_WRONG_VALUES = "One of the values in Aifes block is wrong";
Blockly.Msg.AIFES_DATASET = "dataset";
Blockly.Msg.AIFES_EPOCHS = "epochs";
Blockly.Msg.AIFES_FNN_LAYERS = "number layers";
Blockly.Msg.AIFES_INIT_CLASSIFY_DATA = "initialize classify dataset";
Blockly.Msg.AIFES_INIT_CLASSIFY_DATA_TOOLTIP = "clear classify data memory. Then add raw data multiple times, extract the input features from it and add that to the classify data";
Blockly.Msg.AIFES_INIT_RAW_DATA = "initialize training dataset";
...
Blockly.Msg.AIFES_LEARNINGFUNCTION = "activations function";
Blockly.Msg.AIFES_LEARNINGRATE = "learning rate";
Blockly.Msg.AIFES_LOSS = "loss";
Blockly.Msg.AIFES_MAX_NUMBER_OF_NEURONS = "max neurons";
Blockly.Msg.AIFES_MAX_WEIGHT = "max weight";
Blockly.Msg.AIFES_MIN_WEIGHT = "min weight";
Blockly.Msg.AIFES_MOMENTUM = "momentum";
Blockly.Msg.AIFES_NUMBER_HIDDENLAYERS_NEURONS = "number hidden layers";
Blockly.Msg.AIFES_NUMBER_INPUT_NEURONS = "number input neurons";
Blockly.Msg.AIFES_NUMBER_OF_CLASSES = "number classes";
Blockly.Msg.AIFES_NUMBER_OUTPUT_NEURONS = "number output neurons";
Blockly.Msg.AIFES_OPTIMIER = "optimizer";
Blockly.Msg.AIFES_RAW_DATA = "data";
...
Blockly.Msg.AIFES_WEIGHT = "weight";
...
Blockly.Msg.BACK_LEFT = "back left";
Blockly.Msg.BACK_RIGHT = "back right";
Blockly.Msg.BALLDETECTOR_TOOLTIP = "Represents a ball detector for the camera.";
Blockly.Msg.BATTERY_GETSAMPLE_TOOLTIP = "Gets the current voltage from the battery.";
Blockly.Msg.BELOW = "below";
Blockly.Msg.BLE_ADAPTER_DISABLED = "There is no Bluetooth adapter on your device.<br>Check out the <a href='https://wiki.open-roberta.org/' target='_blank'>Open Roberta Wiki</a> for more information under: Spike Prime / Robot Inventor -> Pybricks -> Set Up.";
Blockly.Msg.BLE_DOWNLOAD_IN_PROGRESS = "The system is busy uploading your program to the robot. Wait a couple of seconds before uploading again.";
Blockly.Msg.BLE_ERROR_CAPABILITIES = "Looks like the firmware version of your robot is not compatible with the Open Roberta Lab. Check out the <a href='https://wiki.open-roberta.org/' target='_blank'>Open Roberta Wiki</a> for more information under: Spike Prime / Robot Inventor -> Pybricks -> Set Up.";
Blockly.Msg.BLE_ERROR_COMMUNICATION = "Whoops something went wrong. Try restarting your robot and upload the program again.";
Blockly.Msg.BLE_ERROR_DEVICE_BUSY = "Looks like your robot is already connected to another instance of the Open Roberta Lab (in another browser tab?).<br> Try to restart your robot or close the other tab.";
Blockly.Msg.BLE_ERROR_PROGRAM_SIZE = "The program is too long for the Spike Prime. Check out the <a href='https://wiki.open-roberta.org/' target='_blank'>Open Roberta Wiki</a> for more information under: Spike Prime / Robot Inventor -> Pybricks";
Blockly.Msg.BLE_ERROR_STOP = "Stopping the program execution does not work, your robot is maybe disconnected?<br>You can always use the Center Button on the hub to stop the program yourself.";
Blockly.Msg.BLE_FEATURE_DISABLED = "Looks like Web Bluetooth is not enabled.<br>Check out the <a href='https://wiki.open-roberta.org/' target='_blank'>Open Roberta Wiki</a> for more information under: Spike Prime / Robot Inventor -> Pybricks -> Set Up.";
Blockly.Msg.BLE_NOT_SUPPORTED = "Your browser does not support Web Bluetooth.<br>Check out the <a href='https://wiki.open-roberta.org/' target='_blank'>Open Roberta Wiki</a> for more information under: Spike Prime / Robot Inventor -> Pybricks -> Set Up.";
Blockly.Msg.BLE_NO_DEVICE_SELECTED = "Looks like you didn't select a device.<br>If your hub was not listed, check out the <a href='https://wiki.open-roberta.org/' target='_blank'>Open Roberta Wiki</a> for more information under: Spike Prime / Robot Inventor -> Pybricks -> Set Up.";
...
Blockly.Msg.BRICKLIGHT_ON_TOOLTIP = "Turns the bricklight on and changes the color.";
...
Blockly.Msg.CAMERA_TOOLTIP = "Represent a camera.";
...
Blockly.Msg.COLORDETECTOR_TOOLTIP = "Represents a color detector for the camera.";
...
Blockly.Msg.COLOUR_HSV_RANGE = "HSV range";
...
Blockly.Msg.COLOUR_SEGMENT = "colour segment";
Blockly.Msg.COLOUR_THRESHOLD = "colour threshold";
...
Blockly.Msg.CONFIGURATION_ERROR_ACTUATOR_WRONG = "The defined actuator port/name is wrong. Please check this in the configuration tab!";
...
Blockly.Msg.CONNECTION_CHANNEL = "channel";
Blockly.Msg.CONNECTION_CHANNEL_RECEIVE_TOOLTIP = "Receive the last message sent to the specified channel.";
Blockly.Msg.CONNECTION_CHANNEL_SEND_TOOLTIP = "Sends a message to another robot over the specified channel.";
...
Blockly.Msg.CONNECTION_MESSAGE = "message";
...
Blockly.Msg.ENCODER_TOOLTIP_ROBOTINO = "Represents an encoder motor.";
...
Blockly.Msg.FRONT_LEFT = "front left";
Blockly.Msg.FRONT_LEFT_MIDDLE = "front left middle";
Blockly.Msg.FRONT_MIDDLE = "front middle";
Blockly.Msg.FRONT_RIGHT = "front right";
Blockly.Msg.FRONT_RIGHT_MIDDLE = "front right middle";
...
Blockly.Msg.GESTURE_TOOLTIP = "represents the the RGB gesture sensor, which detects light, proximity and gestures.";
Blockly.Msg.GET = "get";
...
Blockly.Msg.GROUND_LEFT = "ground left";
Blockly.Msg.GROUND_RIGHT = "ground right";
...
Blockly.Msg.IMU_TOOLTIP = "Represents an Inertial Measurement Unit (IMU)";
Blockly.Msg.INDUCTIVE_TOOLTIP = "Represents an inductive sensor.";
...
Blockly.Msg.INFRARED_DISTANCE_GETSAMPLE_TOOLTIP_ROBOTINO = "Gets the current relative distance from the infrared sensor. The values are between 4 and 30 cm.";
...
Blockly.Msg.LED_BUTTON = "turn button LED on";
Blockly.Msg.LED_BUTTON_ON_TOOLTIP = "Turns the various button LEDs on with the supplied brightness values. The percentage values range from 0% (off) to 100% (full brightness).";
Blockly.Msg.LED_CIRCLE = "turn circle LED on";
Blockly.Msg.LED_CIRCLE_ON_TOOLTIP = "Turns the various circle LEDs on with the supplied brightness values. The percentage values range from 0% (off) to 100% (full brightness).";
Blockly.Msg.LED_MATRIX = "LED matrix";
Blockly.Msg.LED_OFF = "turn LED off";
Blockly.Msg.LED_OFF_BUTTON_THYMIO_TOOLTIP = "Turns the button LED off.";
Blockly.Msg.LED_OFF_CIRCLE_THYMIO_TOOLTIP = "Turns the circle LED off.";
Blockly.Msg.LED_OFF_QUADRGB_TOOLTIP = "Turns off the fill lights of the quad RGB sensor";
Blockly.Msg.LED_OFF_TOOLTIP_NAO = "Turn the selected LED(s) off.";
...
Blockly.Msg.LED_ON_TOOLTIP = "Turns the LED on or off.";
Blockly.Msg.LED_PROXH = "turn distance sensor LED on";
Blockly.Msg.LED_PROXH_ON_TOOLTIP = "Turns the bottom sensor LEDs on with the supplied brightness values. The percentage values range from 0% (off) to 100% (full brightness).";
Blockly.Msg.LED_PROXV = "turn bottom sensor LED on";
Blockly.Msg.LED_PROXV_ON_TOOLTIP = "Turns the various distance sensor LEDs on with the supplied brightness values. The percentage values range from 0% (off) to 100% (full brightness).";
Blockly.Msg.LED_SET_BRIGHTNESS_TOOLTIP = "Sets the brightness of all LEDs [0-100]";
Blockly.Msg.LED_SET_BRIGHTNESS_TOOLTIP_PERCENT = "Sets the brightness of the LED [0-100]";
Blockly.Msg.LED_SET_INTENSITY_TOOLTIP = "Set the intensity of selected LED(s) in a range from 0 to 100. Ears, head and chest LEDs are available";
Blockly.Msg.LED_SOUND = "turn sound sensor LED on";
Blockly.Msg.LED_SOUND_ON_TOOLTIP = "Turns the microphone LED on with the supplied brightness values. The percentage value range from 0% (off) to 100% (full brightness).";
Blockly.Msg.LED_TEMPERATURE = "turn temperature sensor LED on";
Blockly.Msg.LED_TEMPERATURE_ON_TOOLTIP = "Turns the temperature sensor LEDs on with the supplied brightness values. The percentage values range from 0% (off) to 100% (full brightness).";
Blockly.Msg.LED_TOOLTIP = "Represents an LED.";
Blockly.Msg.LED_TOOLTIP_NIBO = "Turns the LED on or off. Watch out, it's very bright!";
...
Blockly.Msg.LINEDETECTOR_TOOLTIP = "Represents a line detector for the camera.";
...
Blockly.Msg.MENU_SIM_ADD_MARKER_OBJECT_TOOLTIP = "Add a marker";
...
Blockly.Msg.MODE_ACCURACY = "accuracy";
...
Blockly.Msg.MODE_MAGNETICFLUX = "magnetic flux";
Blockly.Msg.MODE_MODULATED = "modulated";
Blockly.Msg.MODE_MOISTURE = "moisture";
Blockly.Msg.MODE_MOTION = "motion";
Blockly.Msg.MODE_NAMEALL = "names (list)";
Blockly.Msg.MODE_NAMEONE = "name";
Blockly.Msg.MODE_NOT_SUPPORTED = "The selected mode of this block is not supported by this system!";
Blockly.Msg.MODE_NUMBERLINES = "number of lines";
Blockly.Msg.MODE_OBSTACLE = "obstacle";
Blockly.Msg.MODE_OPEN = "open";
Blockly.Msg.MODE_OPENING = "light";
...
Blockly.Msg.MODE_PROXIMITY = "proximity";
...
Blockly.Msg.MOTIONDETECTOR_TOOLTIP = "Represents a motion detector for the camera.";
...
Blockly.Msg.MOTOROMNI_CURVE_FOR_TOOLTIP = "Starts the robot with the combined speed of specific speeds in two directions [0;100] and stops after a specific distance.";
Blockly.Msg.MOTOROMNI_CURVE_TOOLTIP = "Starts the robot with the combined speed of specific speeds in three directions [0;100].";
Blockly.Msg.MOTOROMNI_POSITION_TOOLTIP = "Drives the robot to a specific coordinate given by the odometry data with a specific speed.";
...
Blockly.Msg.MOTOR_REAR_LEFT = "rear left";
Blockly.Msg.MOTOR_REAR_RIGHT = "rear right";
...
Blockly.Msg.MOTOR_TOOLTIP_SPIKE = "Represents a middle or large angular motor.";
...
Blockly.Msg.NN_EXPLORE_RESET_VALUES = "Reset neuron output values";
Blockly.Msg.NN_EXPLORE_RUN_FULL = "Run forward propagation for the whole network";
Blockly.Msg.NN_EXPLORE_RUN_LAYER = "Run forward propagation layer by layer";
Blockly.Msg.NN_EXPLORE_RUN_NEURON = "Run forward propagation neuron by neuron";
Blockly.Msg.NN_EXPLORE_SHOW_ALL = "show all";
Blockly.Msg.NN_EXPLORE_SHOW_NEXT_NEURON = "next neuron";
Blockly.Msg.NN_FOCUS_OPTION = "show and change";
Blockly.Msg.NN_GENERATE_VALUES_FROM = "from";
Blockly.Msg.NN_GENERATE_VALUES_TO = "to";
Blockly.Msg.NN_GET_BIAS = "get bias";
Blockly.Msg.NN_GET_BIAS_TOOLTIP = "return the value of the bias of a neuron.";
Blockly.Msg.NN_GET_OUTPUT_NEURON_VALUE = "get value output neuron";
...
Blockly.Msg.NN_GET_WEIGHT = "get weight from";
...
Blockly.Msg.NN_INVALID_INPUT_NEURON_VALUE = "invalid input; please enter only numeric values";
Blockly.Msg.NN_INVALID_NEURONNAME = "invalid neuron name";
Blockly.Msg.NN_INVALID_NEURONNAMES = "neurons are not connected";
Blockly.Msg.NN_INVALID_TEST_TRAIN_DATA = "Invalid test/training data uploaded";
Blockly.Msg.NN_LEARNING_RATE = "learning rate";
Blockly.Msg.NN_LEARN_EPOCH = "Train the network for one epoch";
Blockly.Msg.NN_LEARN_EPOCHS_TO_TRAIN = "epochs to train";
Blockly.Msg.NN_LEARN_EPOCH_NUMBER = "Epoch #";
Blockly.Msg.NN_LEARN_ITERATION_NUMBER = "test data line #";
Blockly.Msg.NN_LEARN_ONE_LINE = "Train the network with one line of the training data";
Blockly.Msg.NN_LEARN_RESET_VALUES = "Reset weights and biases to original values";
Blockly.Msg.NN_LEARN_RUN = "Start/pause training for the network";
Blockly.Msg.NN_LEARN_TRAINING_LOSS = "Training loss";
Blockly.Msg.NN_LEARN_UPLOAD = "Upload test/training data file (semicolon separated data accepted)";
Blockly.Msg.NN_LEARN_UPLOAD_POPUP = "Open a popup window and enter input-output test/training data";
Blockly.Msg.NN_OUTPUT_NEURON = "output neuron";
Blockly.Msg.NN_RANDOM_WEIGHTS_BIASES = "random vals";
Blockly.Msg.NN_REGULARIZATION = "regularization";
Blockly.Msg.NN_SET_BIAS = "set bias";
Blockly.Msg.NN_SET_BIAS_TOOLTIP = "change the bias of a neuron.";
Blockly.Msg.NN_SET_INPUT_NEURON_VALUE = "set value input neuron";
Blockly.Msg.NN_SET_INPUT_NEURON_VALUE_TOOLTIP = "set the value of an input neuron for the next step of the neural network.";
Blockly.Msg.NN_SET_WEIGHT = "set weight from";
Blockly.Msg.NN_SET_WEIGHT_TOOLTIP = "change the weight between two neurons.";
Blockly.Msg.NN_SHAPE = "shape";
Blockly.Msg.NN_SHOW_ALL = "show all";
...
Blockly.Msg.NO = "no";
Blockly.Msg.NO_CONST_NOT_SUPPORTED = "Please use a constant instead of an expression here!";
...
Blockly.Msg.OPTION_WEBUSB = "Connect your device to the computer<br><small>select it in the next popup and click »Connect«</small>";
...
Blockly.Msg.ORA_COMPILERWORKFLOW_ERROR_PROGRAM_COMPILE_FAILED = "Your program has errors so it cannot be compiled. The compiler messages are: <br><span style='background-color:#ddd;font-family:courier;'>{MESSAGE}</span>";
...
Blockly.Msg.ORA_COMPILERWORKFLOW_ERROR_PROGRAM_NOT_FOUND = "The program »$« could not be found in the database.";
...
Blockly.Msg.ORA_PROGRAM_GET_ONE_ERROR_NOT_FOUND = "The program »$« could not be found in the database.";
...
Blockly.Msg.ORA_USER_ERROR_EMAIL_INVALID = "There is a problem with your email address. Please try to write the email address lower case. If this doesn't help please contact our support";
...
Blockly.Msg.PHOTOTRANSISTOR_TOOLTIP = "represents a phototransistor sensor that detects light.";
...
Blockly.Msg.PLAY_EXPRESSION_TOOLTIP = "Plays an expressive sound.";
...
Blockly.Msg.PLAY_SOUND = "sound";
Blockly.Msg.PLAY_TONE = "tone";
Blockly.Msg.PLAY_TONE_TOOLTIP = "Plays a tone. Use frequency and duration to determine the tone pitch and duration.";
...
Blockly.Msg.POPUP_TEXTLY_CONFIRM_CONTINUE = "<br><br><i>Press »OK« to see the errors in the textly editor. Press »Cancel« to return to NEPOprog and discard your work.</i>";
...
Blockly.Msg.PROGRAM_ERROR_GESTURE_MODE_INCOMPATIBLE = "This sensor cannot detect gestures while also being used for something else.";
...
Blockly.Msg.RGB_LED_OFF_TOOLTIP = "Turns the RGB LED off.";
Blockly.Msg.RGB_LED_ON_TOOLTIP = "Turns the RGB LED on and changes the color.";
Blockly.Msg.RGB_LED_ON_TOOLTIP_CALLIOPE = "Turns the RGB LED on and changes the color. Attention: calli:Bot only supports 7 different colors, the nearest will be chosen.";
Blockly.Msg.RGB_LED_ON_TOOLTIP_EDISON = "Turns the LED on.";
Blockly.Msg.RGB_LED_TOOLTIP = "Turns the RGB LED on and changes the color.";
...
Blockly.Msg.SENSOR_ACCELEROMETER_VALUE_GETSAMPLE_TOOLTIP_THYMIO = "Returns the acceleration value on the given axis in the range from [-32, 32]";
...
Blockly.Msg.SENSOR_BALLDETECTOR_BALL_GETSAMPLE_TOOLTIP = "Returns a list [x, y, diameter] representing information about a ball matching the color set in the configuration. If no ball is found, returns a list of [-1, -1, -1].";
...
Blockly.Msg.SENSOR_CAMERA_GETSAMPLE_TOOLTIP = "Returns the x-position in pixels of the left most point of a line or -1 if no line was found.";
Blockly.Msg.SENSOR_CAMERA_THRESHOLD_TOOLTIP = "Sets the threshold for color filtering for the marker and color recognition.";
Blockly.Msg.SENSOR_CODE = "code pad";
Blockly.Msg.SENSOR_COLORDETECTOR = "colour detector";
Blockly.Msg.SENSOR_COLORDETECTOR_COLOUR_GETSAMPLE_TOOLTIP = "Returns the average color of the specified camera area (configuration).";
Blockly.Msg.SENSOR_COLOUR = "colour sensor";
Blockly.Msg.SENSOR_COLOURBLOB_TOOLTIP = "Returns information as a list [x, y, size] about the biggest found area of a color in a specific HSV-range in pixels.";
...
Blockly.Msg.SENSOR_COUNTER = "counter";
...
Blockly.Msg.SENSOR_DETECTMARK = "marker sensor";
...
Blockly.Msg.SENSOR_DETECTMARK_IDALL_GETSAMPLE_TOOLTIP_ROBOTINO = "Returns a list IDs (number) of the currently detected marker(s). If no markers are detected, returns a list containing -1.";
Blockly.Msg.SENSOR_DETECTMARK_NAO = "NAO Mark sensor";
...
Blockly.Msg.SENSOR_ENVIRONMENTAL_CALIBRATION_TOOLTIP = "Calibrates the environmental sensor. This takes several minutes.";
...
Blockly.Msg.SENSOR_GESTURE_COLOUR_GETSAMPLE_TOOLTIP = "Gets the current reading from the colour reading of the sensor.";
...
Blockly.Msg.SENSOR_GESTURE_GESTURE_GETSAMPLE_TOOLTIP = "Gets the current gesture reading of the sensor [1-6].";
Blockly.Msg.SENSOR_GESTURE_PROXIMITY_GETSAMPLE_TOOLTIP = "Gets the current proxmity reading of the sensor in percent.";
...
Blockly.Msg.SENSOR_GESTURE_TXT4 = "RGB gesture sensor";
...
Blockly.Msg.SENSOR_IMU = "Inertial measuring unit";
Blockly.Msg.SENSOR_IMU_GETSAMPLE_TOOLTIP = "Gets the current reading from the inertial measurement unit (IMU).";
Blockly.Msg.SENSOR_IMU_TXT4 = "Combi-sensor";
Blockly.Msg.SENSOR_INDUCTIVE = "inductive sensor";
Blockly.Msg.SENSOR_INDUCTIVE_GETSAMPLE_TOOLTIP = "Gets the current reading from the inductive sensor.";
...
Blockly.Msg.SENSOR_INFRARED_TOOLTIP = "Represents an infrared sensor.";
...
Blockly.Msg.SENSOR_KEYC = "front button";
...
Blockly.Msg.SENSOR_LINE_COLOUR_TOOLTIP = "Returns the colour of at the specified index (0-3).";
Blockly.Msg.SENSOR_LINE_INFORMATION_TOOLTIP = "Returns a list [position [-100;100], width] of the line at the specified index (0-3).";
Blockly.Msg.SENSOR_LINE_JOYCAR = "line sensor";
Blockly.Msg.SENSOR_LINE_NUMBERLINES_GETSAMPLE_TOOLTIP = "Returns the number of lines detected by the camera (up to 6).";
Blockly.Msg.SENSOR_LINE_TXT4 = "line detector";
Blockly.Msg.SENSOR_LOGOTOUCH = "logo touch sensor";
Blockly.Msg.SENSOR_LOGOTOUCH_GETSAMPLE_TOOLTIP = "Is the logo touched?";
Blockly.Msg.SENSOR_LOGO_MODE_TOOLTIP = "Change the touch mode of the logo! In resistive mode, touch the ground and the logo together. In capacitive mode, just touch the logo! The default mode is capacitive touch.";
Blockly.Msg.SENSOR_LPS22HB = "LPS22HB";
Blockly.Msg.SENSOR_LSM9DS1 = "LSM9DS1";
Blockly.Msg.SENSOR_MARKERINF_TOOLTIP = "Returns the position data as a list [x,y,distance] of a specific marker ID found in cm. If no markers are detected, returns a list of -1.";
...
Blockly.Msg.SENSOR_MOTIONDETECTOR = "motion detector";
Blockly.Msg.SENSOR_MOTIONDETECTOR_MOTION_GETSAMPLE_TOOLTIP = "Returns a boolean (true or false) indicating whether a specified amount of pixel change, as defined by the sensitivity in the configuration, has occurred.";
...
Blockly.Msg.SENSOR_ODOMETRY_GETSAMPLE_TOOLTIP = "Returns the current position on a specific axis in cm or the orientation. Odometry values are reset every program start.";
Blockly.Msg.SENSOR_ODOMETRY_RESET_TOOLTIP = "Resets the current position on a specific axis or the orientation.";
Blockly.Msg.SENSOR_OPTICAL = "optical sensor";
Blockly.Msg.SENSOR_OPTICAL_GETSAMPLE_TOOLTIP = "Returns the current reading for a optical sensors specific output cable.";
...
Blockly.Msg.SENSOR_PHOTOTRANSISTOR = "phototransistor";
Blockly.Msg.SENSOR_PHOTOTRANSISTOR_GETSAMPLE_TOOLTIP = "Returns True if the phototransistor detects light, otherwise False.";
...
Blockly.Msg.SENSOR_PIN_MODE_TOOLTIP = "Change the touch mode of the logo! In resistive mode, touch the ground and the logo together. In capacitive mode, just touch the logo! The default mode is capacitive touch.";
...
Blockly.Msg.SENSOR_SOUND_THRESHOLD_TOOLTIP = "Sets the threshold [0-255] for quiet or loud sounds for the microphone.";
Blockly.Msg.SENSOR_TAP = "tap sensor";
Blockly.Msg.SENSOR_TAP_GETSAMPLE_TOOLTIP = "Returns 1 if a tap is detected else 0.";
...
Blockly.Msg.SENSOR_TEMPERATURE_RESISTANCE_GETSAMPLE_TOOLTIP = "Gets the current resistance reading from the temperature sensor in ohms.";
Blockly.Msg.SENSOR_TEMPERATURE_SENSEBOX = "temperature/pressure sensor BMP280";
Blockly.Msg.SENSOR_TEMPERATURE_TXT4 = "NTC resistor";
...
Blockly.Msg.SENSOR_TOUCHKEY = "display button";
...
Blockly.Msg.SENSOR_ULTRASONIC_DISTANCE_GETSAMPLE_TOOLTIP_JOYCAR = "Gets the current reading from the ultrasonic sensor in cm. Maximum distance to measure is 450 cm. Minimum distance to measure is 2 cm.";
...
Blockly.Msg.SIM_VALUES_SENSOR = "Sensor Values";
Blockly.Msg.SIM_VALUES_SYSTEM = "System Values";
Blockly.Msg.SIM_VALUES_TIMER = "Timer Values";
Blockly.Msg.SIM_VALUES_VARIABLE = "Variable Values";
...
Blockly.Msg.SOUND_AIRPLANE = "airplane";
Blockly.Msg.SOUND_ALARM = "alarm";
Blockly.Msg.SOUND_ARROW = "arrow";
Blockly.Msg.SOUND_BADDY = "baddy";
Blockly.Msg.SOUND_BA_DING = "ba_ding";
Blockly.Msg.SOUND_BELL = "bell";
Blockly.Msg.SOUND_BIRTHDAY = "birthday";
Blockly.Msg.SOUND_BLUES = "blues";
Blockly.Msg.SOUND_BRAKING = "braking";
Blockly.Msg.SOUND_CARHORN_LONG = "car horn long";
Blockly.Msg.SOUND_CARHORN_SHORT = "car horn short";
Blockly.Msg.SOUND_CENTRAL = "central";
Blockly.Msg.SOUND_CHASE = "chase";
Blockly.Msg.SOUND_COLLISION = "collision";
Blockly.Msg.SOUND_CRACKLING_WOOD = "crackling wood";
Blockly.Msg.SOUND_DADADADUM = "dadadadum";
Blockly.Msg.SOUND_ENTERTAINER = "entertainer";
Blockly.Msg.SOUND_EXCAVATOR = "excavator";
Blockly.Msg.SOUND_FANTASY = "fantasy";
Blockly.Msg.SOUND_FARM = "farm";
Blockly.Msg.SOUND_FIRE = "fire noises";
Blockly.Msg.SOUND_FIRE_DEPARTMENT = "fire department";
Blockly.Msg.SOUND_FORMULAONE = "Formula 1";
...
Blockly.Msg.SOUND_HELICOPTER = "helicopter";
Blockly.Msg.SOUND_HELLO = "hello";
Blockly.Msg.SOUND_HORN_SHIP = "ships horn";
Blockly.Msg.SOUND_HYDRAULIC = "hydraulic";
Blockly.Msg.SOUND_JUMP_DOWN = "jump down";
Blockly.Msg.SOUND_JUMP_UP = "jump up";
Blockly.Msg.SOUND_MOTOR_STARTING = "motor starting";
Blockly.Msg.SOUND_MYSTERIOUS = "mysterious";
Blockly.Msg.SOUND_NYAN = "nyan";
Blockly.Msg.SOUND_ODE = "ode";
Blockly.Msg.SOUND_POWER_DOWN = "power down";
Blockly.Msg.SOUND_POWER_UP = "power up";
Blockly.Msg.SOUND_PRELUDE = "prelude";
Blockly.Msg.SOUND_PROPELLER = "propeller";
Blockly.Msg.SOUND_PUNCHLINE = "punchline";
Blockly.Msg.SOUND_PYTHON = "python";
Blockly.Msg.SOUND_RAISE_HEAD = "raise head";
Blockly.Msg.SOUND_RECORD_DURATION_TOOLTIP = "Get the duration of the recorded sound from the SD-Card.";
Blockly.Msg.SOUND_RECORD_STOP_TOOLTIP = "Stop recording sounds to the SD Card.";
Blockly.Msg.SOUND_RECORD_THYMIO_TOOLTIP = "Start recording sounds on an SD Card connected to your Thymio. The recording is saved as a Rx.wav, where >>x<< is the name of the recording supplied. An SD Card is required!";
Blockly.Msg.SOUND_RECORD_TOOLTIP = "Start or stop recording sounds";
Blockly.Msg.SOUND_RINGTONE = "ringtone";
Blockly.Msg.SOUND_ROLLER_COASTER = "roller coaster";
Blockly.Msg.SOUND_SAD = "sad";
Blockly.Msg.SOUND_SCARY = "scary";
Blockly.Msg.SOUND_SHUTDOWN = "shutdown";
Blockly.Msg.SOUND_SLIDE = "slide";
Blockly.Msg.SOUND_SOARING = "soaring";
Blockly.Msg.SOUND_SPRING = "spring";
Blockly.Msg.SOUND_STARTUP = "startup";
Blockly.Msg.SOUND_TARGET_DETECTED = "target detected";
Blockly.Msg.SOUND_TARGET_FRIENDLY = "target friendly";
Blockly.Msg.SOUND_TILT_HEAD = "tilt head";
Blockly.Msg.SOUND_TOGGLE_TOOLTIP = "Turn the speaker on or off.";
Blockly.Msg.SOUND_TOOLTIP = "Represents a sound sensor.";
Blockly.Msg.SOUND_TRACTOR = "tractor";
Blockly.Msg.SOUND_TRUCK = "truck";
Blockly.Msg.SOUND_TWINKLE = "twinkle";
Blockly.Msg.SOUND_WAWAWAWAA = "wawawawaa";
Blockly.Msg.SOUND_WEDDING = "wedding";
Blockly.Msg.SOUND_WINK = "wink";
...
Blockly.Msg.START_ALL_ROBOTS = "All systems and filter options";
Blockly.Msg.START_BOOKMARK_TOOLTIP = "Create a bookmark directly to your favourite robot/system.";
Blockly.Msg.START_CONNECT_HEADLINE = "Connect your robot";
Blockly.Msg.START_CONNECT_TEXT = "You can directly connect your robot. The suitable NEPO program opens automatically.";
Blockly.Msg.START_FAQ = "Find answers to questions about the Open Roberta Lab that we have been asked so far or that we have already asked ourselves.";
Blockly.Msg.START_FAQ_HEADLINE = "Find answers to important questions";
Blockly.Msg.START_FEATURES = "Features";
Blockly.Msg.START_FIRST_HELP = "First time here? Find support and helpful information.";
Blockly.Msg.START_FOOTER_FRAUNHOFER = "Fraunhofer Institute for Intelligent Analysis and Information Systems IAIS";
Blockly.Msg.START_FOOTER_INFORMATION = "<strong>Information</strong>";
Blockly.Msg.START_FOOTER_RESSOURCES = "<strong>Resources</strong>";
Blockly.Msg.START_FOOTER_ROBERTA_IAIS = "Part of the Roberta Initiative<sup>®</sup> of Fraunhofer IAIS";
Blockly.Msg.START_FORMATSEARCH = "search robots/systems";
Blockly.Msg.START_HEADLINE_PART_FOUR = "Boards";
Blockly.Msg.START_HEADLINE_PART_ONE = "Program";
...
Blockly.Msg.START_IMPORT_TEXT = "Upload your XML file to our lab and continue where you left off.";
...
Blockly.Msg.START_NN = "Neural networks";
Blockly.Msg.START_OPTIONS = "More options";
Blockly.Msg.START_POPULAR_ROBOTS = "Popular systems";
Blockly.Msg.START_PROGLANG = "Programming languages";
...
Blockly.Msg.START_SIMULATION = "Simulation";
Blockly.Msg.START_START = "get started";
...
Blockly.Msg.START_TEXTLY = "NEPO Java";
Blockly.Msg.START_TOOLTIP = "The starting point for the main program.";
Blockly.Msg.START_TOUR_HEADLINE = "Take an interactive tour";
Blockly.Msg.START_WIKI_HEADLINE = "Take a look at our wiki";
Blockly.Msg.START_YOUTUBE_HEADLINE = "Visit us on YouTube";
Blockly.Msg.START_YOUTUBE_TEXT = "On our YouTube channel you will find tutorials, experiments and mini-clips about programming with Open Roberta and robotics in education.";
...
Blockly.Msg.TAB_NN_DEFINE = " Define";
Blockly.Msg.TAB_NN_LEARN = " Learn";
Blockly.Msg.TAB_PROGRAM = "Program";
Blockly.Msg.TAB_TEXTLYJAVA_EDITOR = "Textly Editor";
...
Blockly.Msg.TEXTLY_EDITOR_CLOSE_CONFIRMATION = "There are errors in the code!";
...
Blockly.Msg.TIMER_SET_TOOLTIP = "Sets the timer to defined period in milliseconds.";
...
Blockly.Msg.TURN_BRICKLIGHT = "turn brick light";
Blockly.Msg.TURN_RGBLED = "turn RGB LED";
...
Blockly.Msg.WAIT = "wait seconds";
Blockly.Msg.WAIT_FOR_TOOLTIP = "Waits for sensor values.";
Blockly.Msg.WAIT_OR = "or wait for";
Blockly.Msg.WAIT_TIME_TOOLTIP = "Waits for a certain time in seconds.";
